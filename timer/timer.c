...
void timer_4_init(void)
{
    ...
    PR4 = 8000ul; // Load the period value
...
void timer_5_init(void)
{
    ...
    T5CONbits.TCKPS = 0b10; // Select 1:1 Prescaler
    TMR5 = 0x00; // Clear timer register
    PR5 = 6250ul; // Load the period value
    IPC7bits.T5IP = 0x02; // Set Timer 5 Interrupt Priority Level
