...
FINAL_IMAGE=${DISTDIR}/dspic_can_test.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
else
...
ifneq ($(INFORMATION_MESSAGE), )
	...
	${MAKE}  -f nbproject/Makefile-default.mk ${DISTDIR}/dspic_can_test.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
...
ifeq ($(TYPE_IMAGE), DEBUG_RUN)
${OBJECTDIR}/newmain.o: newmain.c  .generated_files/flags/default/922863dc79ca338d9cb48b1de69c2710eec9ac03 .generated_files/flags/default/ae23d0701649861c3621c34bd6c886fd5536b67b
	@${MKDIR} "${OBJECTDIR}" 
...
${OBJECTDIR}/newmain.o: newmain.c  .generated_files/flags/default/4e3c40832de0ae0af50e10be53fb973eb95a3e43 .generated_files/flags/default/ae23d0701649861c3621c34bd6c886fd5536b67b
	@${MKDIR} "${OBJECTDIR}" 
	@${RM} ${OBJECTDIR}/newmain.o.d 
	@${RM} ${OBJECTDIR}/newmain.o 
...
${DISTDIR}/dspic_can_test.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk   
	...
	${MP_CC_DIR}\\xc16-bin2hex ${DISTDIR}/dspic_can_test.X.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX} -a  -omf=elf   -mdfp="${DFP_DIR}/xc16" 
